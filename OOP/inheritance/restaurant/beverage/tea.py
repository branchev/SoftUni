from inheritance.restaurant.beverage import Beverage
from inheritance.restaurant.beverage import HotBeverage
from inheritance.restaurant.food import Soup
from inheritance.restaurant.product import Product
