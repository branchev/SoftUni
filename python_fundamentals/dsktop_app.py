...
def main_view(tk):
    Button(tk, text="List Tasks", bg="yellow", fg="red").grid(row=0, column=0, padx=20, pady=20)
    Button(tk, text="New Task", bg="yellow", fg="red", command=lambda: create_task(tk)).grid(row=0, column=1, padx=20,
                                                                                             pady=20)
